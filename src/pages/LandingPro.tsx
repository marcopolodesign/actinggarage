...
const LandingPro: React.FC = () => {
  const globalWaUrl = buildWhatsAppUrl('Hola TAG! Quiero más información sobre los cursos Pro');

  return (
    <section className="bg-black min-h-screen">
      <Helmet>
        <title>Garage Pro — Formación Profesional de Interpretación en Barcelona | TAG</title>
        <meta
          name="description"
      ...
      <div className="w-full px-6 sm:px-12 lg:px-24 pt-28 sm:pt-36 pb-20 bg-black">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-white/50 font-garamond max-w-2xl mb-10" style={{ fontSize: 'clamp(1rem, 2.5vw, 1.3rem)' }}>
            Para quienes ya dieron el primer paso y quieren profesionalizarse: técnica avanzada, rodajes de alto nivel y preparación real para la industria.
          </p>

          <div className="flex flex-wrap gap-3">
            {[
              { label: 'Nivel', value: 'Avanzado' },
      ...
      <div className="w-full px-6 sm:px-12 lg:px-24 pb-24 bg-black">
        <div className="max-w-5xl mx-auto space-y-20">
          <div>
            <SectionLabel label="Profesionalización integral" />
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-px bg-white/5">
              <CourseCard
                title="Garage Pro"
                tagline='"El actor honesto"'
                modality="Teatro + Cine (integral)"
                hours="16h/semana"
                startDate="14 sep 2026"
                age="Desde 17 años"
                description="La formación más completa: 3 años de interpretación teatral y a cámara, técnica, cuerpo, voz y gestión emocional para construir una carrera real."
                fullProgramHref="/cursos/garage-pro"
                whatsappMsg="Hola TAG! Quiero más información sobre Garage Pro"
              />
              <CourseCard
                ...
                startDate="14 sep 2026"
                age="17 a 45 años"
                description="Profesionalización sin la carga del Pro: interpretación, cámara, canto e improvisación. El programa de tardes más completo para máxima versatilidad."
                fullProgramHref="/cursos/garage-hybrid-plus"
                whatsappMsg="Hola TAG! Quiero más información sobre Garage Hybrid Plus"
              />
            </div>
          </div>

          <div>
            <SectionLabel label="Continuación — Nivel II y III" />
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-white/5">
              <CourseCard
                title="Garage Theatre II y III"
                tagline='"El actor honesto"'
                modality="Teatro"
                hours="2h/semana"
                startDate="14 sep 2026"
                age="17 a 60 años"
                description="Recorrido histórico del teatro griego al Siglo de Oro y métodos de construcción de personaje, hasta el montaje final en un teatro profesional de Barcelona."
                fullProgramHref="/cursos/garage-theatre"
                whatsappMsg="Hola TAG! Quiero más información sobre Garage Theatre II y III"
                accentLabel="Teatro"
              />
              <CourseCard
                title="Garage Cinema II y III"
                tagline='"El actor honesto"'
                modality="Cine"
                hours="2h/semana"
                startDate="14 sep 2026"
                age="17 a 60 años"
                description="Profundización con escenas complejas y rodajes de alto nivel, hasta la profesionalización: negocio del acting y rodaje profesional de cortometraje."
                fullProgramHref="/cursos/garage-cinema"
                whatsappMsg="Hola TAG! Quiero más información sobre Garage Cinema II y III"
                accentLabel="Cámara"
              />
              <CourseCard
                title="Garage Hybrid II y III"
                tagline='"El actor honesto"'
                modality="Teatro + Cine"
                hours="4h/semana"
                startDate="14 sep 2026"
                age="17 a 60 años"
                description="Escenas complejas, clásicos y métodos de personaje, rodajes de alto nivel y profesionalización combinando teatro y cámara."
                fullProgramHref="/cursos/garage-hybrid"
                whatsappMsg="Hola TAG! Quiero más información sobre Garage Hybrid II y III"
          ...
          <div>
            <SectionLabel label="Para egresados TAG" />
            <div className="grid grid-cols-1 gap-px bg-white/5">
              <CourseCard
                title="Garage Expert Lab"
                tagline='"Evolution"'
                modality="Entrenamiento personalizado"
                hours="Personalizada"
                startDate="Continua / anual"
                age="Desde 17 años"
                ...
                whatsappMsg="Hola TAG! Quiero más información sobre Garage Expert Lab (Evolution)"
              />
            </div>
          </div>
        </div>
      ...
      <div className="w-full bg-tag-yellow px-6 sm:px-12 lg:px-24 py-20">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-black/60 font-garamond text-lg mb-8">
            Escríbenos por WhatsApp y te contamos cuál es tu camino ideal.
          </p>
          <a
            href={globalWaUrl}
            target="_blank"
