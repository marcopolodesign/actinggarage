...
const COURSE_NAME = 'Garage New Generation';

const LandingNewGeneration: React.FC = () => {
  ...
  const reasons = [
    ...
    'Empatía y comprensión de perspectivas diferentes.',
  ...
  const q1Content = [
    ...
    'Consolidación y muestra interna de bloque',
  ];
  ...
  return (
    <section className="bg-black min-h-screen">
      <Helmet>
        <title>Garage New Generation — Teatro para jóvenes de 13 a 17 años | TAG</title>
        <meta
          name="description"
          content="Del juego a la identidad artística. Teatro para jóvenes de 13 a 17 años en TAG. Grupos pequeños, profesores en activo, muestra final cada cuatrimestre. Curso 2026/2027."
        />
        <meta name="title" content="Garage New Generation — Teatro para jóvenes de 13 a 17 años | TAG" />
      </Helmet>
      ...
      <div className="w-full px-6 sm:px-12 lg:px-24 pt-28 sm:pt-36 pb-16 bg-black">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-white/40 font-garamond mb-10 max-w-xl" style={{ fontSize: 'clamp(0.9rem, 2vw, 1.1rem)' }}>
            Buscamos formar jóvenes actores y actrices con criterio propio, capaces de comprometerse con proyectos teatrales exigentes y de encontrar su propia voz artística.
          </p>
      ...
      <div className="w-full px-6 sm:px-12 lg:px-24 pb-20 bg-black">
        <div className="max-w-3xl mx-auto">
          {/* TODO: Replace video ID 'ioPES8OreeY' with the Garage New Generation video */}
          <div className="w-full mb-8" style={{ padding: '56.25% 0 0 0', position: 'relative' }}>
            <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%' }}>
              <iframe
                ...
                title="Garage New Generation — TAG"
      ...
      <div className="w-full px-6 sm:px-12 lg:px-24 py-20 border-t border-white/5">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-white/30 font-garamond text-xl sm:text-2xl mb-12 max-w-2xl">
            En TAG creemos que la adolescencia es uno de los momentos más ricos y complejos para trabajar la interpretación. El teatro les ofrece un espacio seguro para:
          </p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-px bg-white/5">
            ...
            <div className="bg-black p-8">
              ...
              <h3 className="font-druk text-white text-2xl sm:text-3xl uppercase mb-2">BASES ACTORALES</h3>
              <p className="text-white/40 font-garamond text-base italic mb-6">"Construyendo las herramientas del actor y la actriz joven"</p>
              <p className="text-tag-yellow/60 text-[10px] uppercase tracking-widest font-druk mb-3">Bases Físicas, Vocales y Relacionales</p>
            ...
            <div className="bg-black p-8">
              ...
              <p className="text-white/40 font-garamond text-base italic mb-6">"Personajes, emociones y escenas contemporáneas"</p>
              <p className="text-tag-yellow/60 text-[10px] uppercase tracking-widest font-druk mb-3">Personajes, Emoción e Improvisación</p>
              <ul className="space-y-2">
...
export default LandingNewGeneration;
