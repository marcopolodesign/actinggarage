...
const COURSE_NAME = 'Garage Mini Kids';

const LandingMiniKids: React.FC = () => {
  ...
  const q1Content = [
    'Desinhibición y confianza en el espacio',
    'Conciencia corporal y movimiento expresivo',
    'Mirada, escucha y trabajo en equipo',
    'Consolidación y juegos de cierre de bloque',
  ];

  const q2Content = [
    'Creación de personajes simples: animales, objetos mágicos, diferentes tipos de personas',
    'Emociones básicas y expresividad: alegría, tristeza, miedo, sorpresa, enfado',
    'Introducción al texto dramático: primeras palabras en escena con textos muy sencillos',
    'Pequeñas escenas guiadas: improvisaciones y escenas cortitas con estructura',
    'Ensayos con puesta en escena: construimos pequeñas historias entre todos y todas',
  ];
  ...
  return (
    <section className="bg-black min-h-screen">
      <Helmet>
        <title>Garage Mini Kids — Teatro para niños de 6 a 8 años | TAG</title>
        <meta
          name="description"
          content="El juego como herramienta. Teatro infantil para niños y niñas de 6 a 8 años en TAG. Grupos pequeños, profesores en activo. Curso 2026/2027."
        />
        <meta name="title" content="Garage Mini Kids — Teatro para niños de 6 a 8 años | TAG" />
      </Helmet>
      ...
      <div className="w-full px-6 sm:px-12 lg:px-24 pt-28 sm:pt-36 pb-16 bg-black">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-white/40 font-garamond mb-10 max-w-xl" style={{ fontSize: 'clamp(0.9rem, 2vw, 1.1rem)' }}>
            No buscamos crear "pequeños actores perfectos". Buscamos niños y niñas felices, expresivos y seguros de sí mismos.
          </p>
      ...
      <div className="w-full px-6 sm:px-12 lg:px-24 pb-20 bg-black">
        <div className="max-w-3xl mx-auto">
          {/* TODO: Replace video ID 'ioPES8OreeY' with the Garage Mini Kids video */}
      ...
      <div className="w-full px-6 sm:px-12 lg:px-24 py-20 border-t border-white/5">
        <div className="max-w-4xl mx-auto">
          <h2 className="font-druk text-white leading-none mb-3" style={{ fontSize: 'clamp(2rem, 6vw, 4rem)' }}>
            ¿POR QUÉ TAG PARA LOS{' '}
            <span className="text-tag-yellow">MÁS PEQUEÑOS?</span>
          </h2>
          <p className="text-white/30 font-garamond text-xl sm:text-2xl mb-12 max-w-2xl">
            En TAG creemos que el teatro infantil debe ser, ante todo, un espacio de juego, descubrimiento y expresión libre.
          </p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-px bg-white/5">
            ...
            <div className="bg-black p-8">
              ...
              <h3 className="font-druk text-white text-2xl sm:text-3xl uppercase mb-2">FUNDAMENTOS DEL JUEGO TEATRAL</h3>
              <p className="text-white/40 font-garamond text-base italic mb-6">"Conocernos, perder la vergüenza y divertirnos juntos"</p>
              <p className="text-tag-yellow/60 text-[10px] uppercase tracking-widest font-druk mb-3">Juego, Cuerpo y Grupo</p>
            ...
            <div className="bg-black p-8">
              ...
              <h3 className="font-druk text-white text-2xl sm:text-3xl uppercase mb-2">HERRAMIENTAS DE INTERPRETACIÓN Y MUESTRA FINAL</h3>
              <p className="text-white/40 font-garamond text-base italic mb-6">"Empezamos a ser personajes y contar historias"</p>
              <p className="text-tag-yellow/60 text-[10px] uppercase tracking-widest font-druk mb-3">Personajes, Emociones y Escenas</p>
              <ul className="space-y-2">
...
export default LandingMiniKids;
