...
const COURSE_NAME = 'Garage Hybrid';
const LANDING_SOURCE = 'landing_hybrid';

const LandingHybrid: React.FC = () => {
  ...
  const stats = [
    ...
    { label: 'Dedicación', value: '4h/semana' },
    { label: 'Edad', value: '17–60 años' },
  ...
  const learningPillars = [
    {
      ...
      desc: 'Técnica actoral sobre los escenarios: texto, cuerpo, presencia y construcción de personaje desde cero.',
    },
    {
      icon: '🎬',
      title: 'Actuación ante Cámara',
      desc: 'Interpretación para cine y televisión: framing, continuidad, actuación con dirección y trabajo en set.',
    },
    {
      icon: '🔄',
      title: 'Metodología Dual',
      desc: 'Integración fluida de ambas disciplinas para desarrollar un actor versátil en cualquier formato e industria.',
    },
    {
      icon: '🎯',
      title: 'Preparación para Audiciones',
      desc: 'Técnicas reales para enfrentar castings de teatro, cine, publicidad y series con confianza y criterio.',
    },
  ];
  ...
  const faqs = [
    {
      ...
      a: 'No. El Garage Hybrid está diseñado para recibir a estudiantes sin experiencia previa, así como a actores con recorrido que quieran integrar teatro y cine en su formación.',
    },
    {
      q: '¿Cuándo empieza el próximo curso?',
      a: 'Las nuevas cohortes abren inscripción cada año. Contáctanos por WhatsApp o rellena el formulario y te informaremos sobre las próximas fechas de inicio.',
    },
    {
      q: '¿Qué pasa si no puedo asistir a alguna clase?',
      a: 'Contamos con un sistema de recuperación de clases para situaciones puntuales. Pedimos compromiso y regularidad, ya que el trabajo en grupo es parte esencial del método.',
    },
    {
      q: '¿Qué diferencia hay entre Garage Hybrid y Garage Hybrid Plus?',
      a: 'El Hybrid Plus duplica la carga horaria (8h vs 4h semanales), añade formación en canto y expresión vocal, e incorpora un enfoque más intensivo en creación artística personal. Está pensado para quienes buscan una profesionalización más profunda.',
    },
    {
      q: '¿Cómo me inscribo?',
      a: 'Rellena el formulario en esta página o contáctanos directamente por WhatsApp. Nuestro equipo te guiará en el proceso de inscripción y resolverá todas tus dudas.',
    },
  ];
  ...
  return (
    <section className="bg-black min-h-screen">
      <Helmet>
        <title>Garage Hybrid — Teatro & Cine | TAG Escuela de Actuación</title>
        <meta
          name="description"
          content="Formación dual en teatro y cine durante 3 años. Garage Hybrid es el curso para actores que quieren dominar el escenario y la cámara. Inscríbete en TAG."
        />
        <meta name="title" content="Garage Hybrid — Teatro & Cine | TAG Escuela de Actuación" />
      </Helmet>
      ...
      <div className="w-full px-6 sm:px-12 lg:px-24 pt-28 sm:pt-36 pb-16 bg-black">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-white/70 font-garamond mb-10 max-w-xl" style={{ fontSize: 'clamp(1rem, 2.5vw, 1.4rem)' }}>
            Teatro y Cine. Un solo camino hacia la profesionalización actoral.
          </p>
      ...
      <div className="w-full px-6 sm:px-12 lg:px-24 py-20 border-t border-white/5">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-white/30 font-garamond text-xl sm:text-2xl mb-12 max-w-xl">
            Una formación que integra el escenario y la cámara desde el primer día.
          </p>
