...
const COURSE_NAME = 'New Generation Cámara';

const LandingNewGenerationCamara: React.FC = () => {
  ...
  const getWhatsAppUrl = () => {
    return buildWhatsAppUrl(
      `Hola TAG! Quiero más información sobre el ${COURSE_NAME} (13-17 años)`,
      `Hola TAG! Quisiera obtener más información sobre el ${COURSE_NAME} (13-17 años)`
    );
  };
  ...
  const reasons = [
    ...
    'Aprender a habitar la cámara con verdad y sin miedo.',
    'Desarrollar herramientas actorales específicas para el audiovisual.',
    'Entender la diferencia entre actuar para un público y actuar para un objetivo.',
    'Jugar, pero jugar MUY EN SERIO.',
  ];

  const q1Content = [
    'Romper el hielo con la cámara — La cámara es tu amiga',
    'Aprender a relajarnos y reconocer tensión',
    'Jugar con emociones y conectar',
    'La imaginación como herramienta',
    'Primer contacto con textos contemporáneos',
  ...
  const q2Content = [
    ...
    'Análisis de texto: profundizar en los textos',
    'Trabajo de escenas en pareja',
    'Técnica básica para cámara',
  ];
  ...
  return (
    <section className="bg-black min-h-screen">
      <Helmet>
        <title>New Generation Cámara — Actuación para jóvenes de 13 a 17 años | TAG</title>
        <meta
          name="description"
          content="Conocerse delante de la cámara. Actuación audiovisual para jóvenes de 13 a 17 años en TAG. Rodajes reales, grupos pequeños, profesores en activo. Curso 2026/2027."
        />
        <meta name="title" content="New Generation Cámara — Actuación para jóvenes de 13 a 17 años | TAG" />
      </Helmet>
      ...
      <div className="w-full px-6 sm:px-12 lg:px-24 pt-28 sm:pt-36 pb-16 bg-black">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-white/70 font-garamond mb-2 max-w-xl" style={{ fontSize: 'clamp(1rem, 2.5vw, 1.4rem)' }}>
            "CONOCERSE DELANTE DE LA CÁMARA"
          </p>
          <p className="text-white/40 font-garamond mb-10 max-w-xl" style={{ fontSize: 'clamp(0.9rem, 2vw, 1.1rem)' }}>
            Buscamos formar jóvenes actores y actrices capaces de comprometerse con el trabajo de cámara y de encontrar su propia voz artística delante de un objetivo.
          </p>
      ...
      <div className="w-full px-6 sm:px-12 lg:px-24 pb-20 bg-black">
        <div className="max-w-3xl mx-auto">
          {/* TODO: Replace video ID 'ioPES8OreeY' with the New Generation Cámara video */}
          <div className="w-full mb-8" style={{ padding: '56.25% 0 0 0', position: 'relative' }}>
            <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%' }}>
              <iframe
                ...
                title="New Generation Cámara — TAG"
      ...
      <div className="w-full px-6 sm:px-12 lg:px-24 py-20 border-t border-white/5">
        <div className="max-w-4xl mx-auto">
          <h2 className="font-druk text-white leading-none mb-3" style={{ fontSize: 'clamp(2rem, 6vw, 4rem)' }}>
            ¿POR QUÉ TAG PARA{' '}
            <span className="text-tag-yellow">JÓVENES DE 13 A 17 AÑOS?</span>
          </h2>
          <p className="text-white/30 font-garamond text-xl sm:text-2xl mb-12 max-w-2xl">
            La adolescencia es uno de los momentos más ricos para trabajar la interpretación. La cámara les ofrece un espacio para:
          </p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-px bg-white/5">
            ...
            <div className="bg-black p-8">
              ...
              <h3 className="font-druk text-white text-2xl sm:text-3xl uppercase mb-2">FUNDAMENTOS DE CÁMARA</h3>
              <p className="text-white/40 font-garamond text-base italic mb-6">"Conocerte como actor y construir las bases"</p>
              <p className="text-tag-yellow/60 text-[10px] uppercase tracking-widest font-druk mb-3">Conexión con la Cámara y Presencia</p>
              ...
              <div className="mt-6 p-4 border border-tag-yellow/20 bg-tag-yellow/5">
                ...
                <p className="text-white/40 font-garamond text-sm">Cada alumno rueda su propio monólogo de 1,5–2 minutos. Material grabado disponible para el alumno.</p>
              </div>
            </div>
            ...
            <div className="bg-black p-8">
              ...
              <h3 className="font-druk text-white text-2xl sm:text-3xl uppercase mb-2">HERRAMIENTAS AVANZADAS PARA JÓVENES</h3>
              <p className="text-white/40 font-garamond text-base italic mb-6">"Personajes, emoción y técnica básica de cámara"</p>
              <p className="text-tag-yellow/60 text-[10px] uppercase tracking-widest font-druk mb-3">Personajes, Emoción y Técnica de Rodaje</p>
              <ul className="space-y-2">
...
export default LandingNewGenerationCamara;
