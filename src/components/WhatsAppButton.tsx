  ...
  return (
    ...
    >
      <div className="relative group">
        {/* Circle background */}
        <div className="w-14 h-14 rounded-full bg-black border-2 border-tag-yellow flex items-center justify-center hover:scale-110 transition-transform duration-300">
          {/* WhatsApp Icon */}
          <svg 
            width="28" 
            height="28" 
        ...
        <div className="absolute right-full mr-3 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none whitespace-nowrap">
          <div className="bg-black text-tag-yellow px-3 py-2 rounded-lg text-sm font-medium border border-tag-yellow">
